...
setup(
    ...
    url='https://github.com/ksugar/stardist-sparse',
    author='Ko Sugawara, Uwe Schmidt, Martin Weigert',
    author_email='ko.sugawara@riken.jp, research@uweschmidt.org, martin.weigert@epfl.ch',
